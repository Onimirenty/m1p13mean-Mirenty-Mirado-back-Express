...
router.post("/", checkToken, checkRole("ADMIN", "OWNER"), requireMultipart,  uploadProduitImages,ProduitController.createProduit);
router.put("/:id", checkToken, checkRole("ADMIN", "OWNER"), requireMultipart,  uploadProduitImages,ProduitController.updateProduit);
